...
async def test_cannot_read_user_that_does_not_exists(api_client: ApiClient) -> None:
...
async def test_cannot_read_user_by_other_user(api_client: ApiClient) -> None:
...
async def test_cannot_read_user_without_auth(api_client: ApiClient) -> None:
